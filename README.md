...
(discordi server, millesse sõnum saadetakse: https://discord.gg/qr4RssDH9J)
 ...
 Moodulid - tkcalendar, customtkinter,  spire.xls, spire, pandas [("pip install openpyxl"), kui openpyxl ei tööta, siis: "pip install pandas --upgrade"?], numpy, discordwebhook, discord, httplib2, bs4, socket
