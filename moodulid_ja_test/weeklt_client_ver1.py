...
def recieve_xslx(s):
    ...
    byte_length = s.recv(4)
#     print(byte_length)
    byte_length_update = int.from_bytes(byte_length, 'big')  # Convert bytes to integer
#     print(byte_length_update)
    flyname_bytes = s.recv(byte_length_update)
#     print (flyname_bytes)# Read the specified length of bytes for the file name
...
def send_xslx(send11, s):
    ...
    flyfile = os.path.join(dir_name_slash, send11) # leia file ja nimi
